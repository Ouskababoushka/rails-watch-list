...
puts 'Erasing db seed...'
Movie.destroy_all
List.destroy_all
Bookmark.destroy_all

puts 'adding my sexy seed...'
...
love = List.create(name: "Love")
action = List.create(name: "Action")
scifi = List.create(name: "SciFi")

Bookmark.create(comment: "cool movie", list_id: action.id, movie_id: wonder_woman.id)
Bookmark.create(comment: "cool movie", list_id: drama.id, movie_id: titanic.id)
